...
%% Add current path to MATLAB PATH
    ...
    % parameters
    global gb_params;
    gb_params.border_px = 10; % to exclude border region
    gb_params.crop_radius_px = 6; % no use ???
    ...
    gb_params.fit_cropped_r = 10; % cropped radius for fitting,
                                  % previouslly 8
    gb_params.fit_d = 1; % half width of the line profile for erfc
    gb_params.crop_radius_px_erfc_v2 = 10; % used to profiling
    gb_params.thres_dist = 10; % used to exclude candidates that
                               % are too far away in calc_mt_end_v2
    ...
    % calc_mt_end/
    global gb_mt_plus_params;
    global gb_mt_minus_params;
    global gb_is_preprocessed;
    gb_is_preprocessed = 0;
    ...
    set(h_load_images_pbutt, 'Enable', 'on');
